...
const file_order_v1_order_service_proto_rawDesc = "" +
	"\n" +
	"\x1corder/v1/order_service.proto\x12\border.v1\x1a\x1bbuf/validate/validate.proto\x1a\x14order/v1/order.proto\"_\n" +
	"\x0fCreateOrderItem\x12'\n" +
	"\n" +
	"product_id\x18\x01 \x01(\tB\b\xbaH\x05r\x03\xb0\x01\x01R\tproductId\x12#\n" +
	"\bquantity\x18\x02 \x01(\x05B\a\xbaH\x04\x1a\x02 \x00R\bquantity\"\x9b\x01\n" +
	"\x12CreateOrderRequest\x12!\n" +
	"\auser_id\x18\x01 \x01(\tB\b\xbaH\x05r\x03\xb0\x01\x01R\x06userId\x12'\n" +
	"\n" +
	"address_id\x18\x02 \x01(\tB\b\xbaH\x05r\x03\xb0\x01\x01R\taddressId\x129\n" +
	"\x05items\x18\x03 \x03(\v2\x19.order.v1.CreateOrderItemB\b\xbaH\x05\x92\x01\x02\b\x01R\x05items\"<\n" +
	"\x13CreateOrderResponse\x12%\n" +
	"\x05order\x18\x01 \x01(\v2\x0f.order.v1.OrderR\x05order2Z\n" +
	"\fOrderService\x12J\n" +
	"\vCreateOrder\x12\x1c.order.v1.CreateOrderRequest\x1a\x1d.order.v1.CreateOrderResponseB\xad\x01\n" +
	"\fcom.order.v1B\x11OrderServiceProtoP\x01ZIgithub.com/maksimegorovdev/delivery-backend/proto/gen/go/order/v1;orderv1\xa2\x02\x03OXX\xaa\x02\bOrder.V1\xca\x02\bOrder\\V1\xe2\x02\x14Order\\V1\\GPBMetadata\xea\x02\tOrder::V1b\x06proto3"
...
var file_order_v1_order_service_proto_goTypes = []any{
	(*CreateOrderItem)(nil),     // 0: order.v1.CreateOrderItem
...
var file_order_v1_order_service_proto_depIdxs = []int32{
	0, // 0: order.v1.CreateOrderRequest.items:type_name -> order.v1.CreateOrderItem
	3, // 1: order.v1.CreateOrderResponse.order:type_name -> order.v1.Order
